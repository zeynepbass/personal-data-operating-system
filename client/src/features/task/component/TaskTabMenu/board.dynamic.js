...
export const ListView = dynamic(
  () => import("@/shared/components/molecules").then((mod) => mod.ListView),
  {
...
export const TableView = dynamic(
  () => import("@/shared/components/molecules").then((mod) => mod.TableView),
  {
    loading: () => <div className="py-10 text-center">Yükleniyor...</div>,
  }
);
...
export const Column = dynamic(
  () => import("@/shared/components/molecules").then((mod) => mod.Column),
  {
...
export const Modal = dynamic(
  () => import("@/shared/components/molecules").then((mod) => mod.Modal)
);
