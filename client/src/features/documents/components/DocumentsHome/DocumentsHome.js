...
export default function DocumentsHome({
 ...
 <div
 key={doc.id}
 className={`group cursor-pointer rounded-2xl border bg-white p-5 shadow transition duration-300 hover:-translate-y-1 hover:shadow-lg ${
   doc.shared
     ? "border-purple-300 shadow-[0_0_15px_rgba(125,120,206,0.35)] hover:border-purple-500 hover:shadow-[0_0_22px_rgba(125,120,206,0.5)]"
     : "border-gray-200 hover:border-[rgb(125,120,206)]"
 }`}
>
              {" "}
